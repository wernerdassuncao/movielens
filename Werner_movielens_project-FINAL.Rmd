...
As we can observe from the table above, the best performing method was the Recosystem - Parallel Matrix Factorization with a `r MF_method_rmse` RMSE. This was our best performing model. We will use it for the final test: how it performs on the validation set (unseen/unknown data).
